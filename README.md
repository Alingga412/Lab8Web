...
```
![img](img/membuat_database.png)

## 3). MENAMBAHKAN DATA
![img](img/menambahkan_data.png)
...
![img](img/tambah_create.png)

**PENJELASAN**

Program menambahkan data atau ***Create***
![img](img/create_fulltampilan.png)
...
![img](img/full_tampilan.png)

maka hasilnya akan seperti dibawah

![img](img/hasil_ubah.png)
